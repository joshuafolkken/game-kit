...
execute unattended. The canonical extended reference is `node_modules/@joshuafolkken/kit/prompts/collaboration-workflow/` — `epic-bundle.md`, `epic-audit.md` and `cross-repo-epic.md` between them; this
...
`node_modules/@joshuafolkken/kit/prompts/collaboration-workflow/epic-plan.md` is a pointer to this file rather than a second copy.
