...
export const BORDER_THICKNESS_HALF = BORDER_THICKNESS / HALF_DIVISOR
...
export const CYBER_INNER_RING_ROTATION = Math.PI / RING_ROTATION_DIVISOR
...
export const CORNER_ARM_HALF = CORNER_ARM / HALF_DIVISOR
...
export const PANEL_TEXT_Y = (FPS_BAR_BASE_Y - PANEL_HALF) / HALF_DIVISOR
export const PANEL_TEXT_Z = 0.05
export const PANEL_TEXT_FONT_SIZE = 0.09

export const HIT_AREA_W = PANEL_SIZE + HIT_AREA_PADDING
export const HIT_AREA_H = PANEL_SIZE + HIT_AREA_PADDING
